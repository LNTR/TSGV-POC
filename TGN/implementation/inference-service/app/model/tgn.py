...
class TGN(torch.nn.Module):
    def __init__(
        ...
        self.textual_lstm_encoder = TextualLSTMEncoder(word_embed_size, hidden_size_textual)
        self.visual_lstm_encoder = VisualLSTMEncoder(visual_feature_size, hidden_size_visual)
        self.interactor = Interactor(hidden_size_textual, hidden_size_visual, hidden_size_ilstm)
        self.grounder = Grounder(hidden_size_ilstm, k_scales)
